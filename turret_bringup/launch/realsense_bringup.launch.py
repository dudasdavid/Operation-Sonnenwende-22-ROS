...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rgbd', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '848,480,6', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '848,480,6', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_format',    'default': 'Z16', 'description': 'depth stream format'},
                           {'name': 'depth_module.infra_profile',   'default': '848,480,6', 'description': 'infra streams (0/1/2) profile'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '848,480,6', 'description': 'Depth module color stream profile for d405'},
