...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rgbd', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '424,240,6', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '424,240,6', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_format',    'default': 'Z16', 'description': 'depth stream format'},
                           {'name': 'depth_module.infra_profile',   'default': '424,240,6', 'description': 'infra streams (0/1/2) profile'},
                           ...
                           {'name': 'depth_module.color_profile',   'default': '424,240,6', 'description': 'Depth module color stream profile for d405'},
                           ...
                           {'name': 'depth_module.emitter_enabled',          'default': '1', 'description': 'Enable laser dot emitter'},
                           ...
                           {'name': 'base_frame_id',                'default': 'camera_link', 'description': 'Root frame of the sensors transform tree'},
