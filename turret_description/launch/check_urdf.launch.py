...
def generate_launch_description():
    ...
    pkg_turret = FindPackageShare('turret_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_turret, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the turret package
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'turret_description',
