...
def processAngle(motor_id, input_byte_array):
    #print(motor_id, input_byte_array)
    ...
    angle = int.from_bytes(input_bytes, byteorder='big', signed=True) / 65535.0 * 360.0
    #print(int.from_bytes(input_bytes, byteorder='big', signed=True))

    return angle

def processAngleError(motor_id, input_byte_array):
    #print(motor_id, input_byte_array)
